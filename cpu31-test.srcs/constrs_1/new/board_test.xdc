# Board-only constraints for the seven-segment display top module `test`.
# Use this file for bitstream generation/downloading, not for postsim_top timing simulation.
